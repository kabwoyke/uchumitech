  ...
  const services = [
    {
      ...
      gradient: "from-kenya-blue to-blue-600",
    },
    {
      icon: Smartphone,
      ...
      gradient: "from-kenya-green to-green-600",
    },
    {
      icon: Settings,
      ...
      gradient: "from-kenya-orange to-orange-600",
    },
  ];
                  ...
                  <ul className="space-y-2">
                    {service.features.map((feature) => (
                      <li key={feature} className="flex items-center text-gray-600">
                        <Check className="text-kenya-green mr-3" size={16} />
                        {feature}
                      </li>
                    ))}
                  </ul>
